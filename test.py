...
def main(args):
    ...
    with open(os.path.join(DATA_ROOT, 'property.txt'), 'r') as f:
    ...
    #debug
    w = torch.load(model_root,map_location=torch.device('cpu'))
...
def parse_arguments(argv):
    ...
    parser.add_argument('--target', default='pose_02,pose_03,pose_04,pose_05,pose_06,pose_07,pose_08,cplfw_all',
                        help='')
